...
export default function BuyerMessageReception(props) {
  const { storeName, buyerName, messageContent, chattingThreadLink, year } =
    props

  const preview = `【つなぐマーケット】${storeName}さんからメッセージが届いています`
        ...
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              {buyerName}様 <br />
              <br />
              {storeName}さんからメッセージが届きました。
              <br />
            </Text>
            <Text style={heading}>■ メッセージ内容</Text>
            <Text style={paragraph}>{nl2br(messageContent)}</Text>
