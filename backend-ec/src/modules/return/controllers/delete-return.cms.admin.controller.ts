...
/**
 * @oas [post] /return/{id}/delete
 * operationId: "deleteReturnAdminCms"
 * summary: "delete Return Admin Cms"
 * description: "delete Return Admin Cms"
 ...
 *
 */
const deleteReturnController = async (
  ...
  await returnService.deleteCms(id)
  res.sendStatus(200)
}

export default deleteReturnController
