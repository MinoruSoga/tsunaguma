...
/**
 * @oas [get] /list-order-store
 * operationId: GetListOrderByStore
 * summary: Get list order by store
 * parameters:
...
const getListOrderStore = async (
  ...
  const [orders, count] = await orderService.listOrdersStore(
...
export class GetListOrderStoreParams {
