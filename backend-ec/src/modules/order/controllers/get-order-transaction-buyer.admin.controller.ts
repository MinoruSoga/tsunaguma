...
/**
 * @oas [get] /list-transaction-buyer
 * operationId: GetListTransactionByBuyer
 * summary: Get list transaction by buyer
 * parameters:
 ...
 */
const getListTransactionBuyer = async (
  ...
  const [orders, count] = await orderService.listTransactionBuyer(
    loggedInUser.id,
...
export default getListTransactionBuyer

export class GetListTransactionBuyerParams {
