...
/**
 * @oas [post] /chatting/threads/{id}/read
 * operationId: "ReadMessageInThread"
 * summary: "Set read message in chatting thread"
 * description: "Set read message in chatting thread"
...
export default async (req: MedusaRequest, res: Response) => {
  ...
  await chattingService.markReadMessage(id, loggedInUser.id)
  res.sendStatus(201)
}
