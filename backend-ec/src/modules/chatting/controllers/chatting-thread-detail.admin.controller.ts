...
/**
 * @oas [get] /chatting/threads/{id}
 * operationId: "GetChattingThreadDetail"
 * summary: "Get chatting thread detail"
 * description: "Get chatting thread detail."
...
export default async (req: MedusaRequest, res: Response) => {
  ...
  const data = await chattingService.chattingThread(id, loggedInUser.id)
  res.json(data)
}
