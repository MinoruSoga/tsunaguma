...
/**
 * @oas [patch] /return-delivery/{id}/pause
 * operationId: "pauseReturnDeliveryAdminCms"
 * summary: "pause Return Delivery Admin Cms"
 ...
 *
 */
const pauseReturnDeliveryController = async (
  ...
  await returnDeliveryService.pause(id)
  res.sendStatus(200)
}

export default pauseReturnDeliveryController
