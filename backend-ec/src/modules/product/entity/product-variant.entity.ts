...
import { DeliveryRequestVariant } from '../../delivery-request/entities/delivery-request-variant.entity'
...
export class ProductVariant extends MedusaProductVariant {
  ...
  // extra fields for delivery request
  ...
  @OneToMany(() => DeliveryRequestVariant, (d) => d.variant)
