...
export class ShippingProfile extends MedusaShippingProfile {
  ...
  private beforeInsertDefaultVals(): void {
    ...
    if (!this.type) {
      this.type = ShippingProfileType.DEFAULT
    }
  }
}
 ...
 *   store_id:
 *     type: string
 *     description: "The store id which reference to shipping profile."
 *     example: store_12345
 *   store:
 *     type: object
 *     description: "The store which reference to shipping profile."
