import { DiscountCondition as MedusaDiscountCondition } from '@medusajs/medusa'
 ...
 *   store_groups:
 *     description: store groups associated with this condition if type = store_groups. Available if the relation `store_groups` is expanded.
 *     type: array
 *     items:
 *       type: object
 *       description: A store group object.
 *   created_at:
 *     type: string
