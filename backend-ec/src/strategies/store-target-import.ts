...
class StoreTargetImportStrategy extends AbstractBatchJobStrategy {
  static identifier = 'store-target-import-strategy'
  static batchType = 'store-target-import'
...
export default StoreTargetImportStrategy
